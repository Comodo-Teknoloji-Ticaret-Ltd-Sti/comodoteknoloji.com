            ...
            {/* AI Assistant Toggle Button */}
            {
                !isChatOpen && (
                    <button
                        ...
                        className="fixed bottom-4 right-4 z-50 w-16 h-16 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center"
                    >
